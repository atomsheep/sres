  ...
  <#--
    ...
    <div style='left:40%;position:absolute;top:51px;bottom:0;right:0;overflow-y:scroll;padding:20px'>
        <div>
            ...
            <button class="btn btn-default btn-primary" style='float:right;margin-right:10px'>Preview email</button>
        </div>
    ...
    <table style='width:100%'>
                ...
                <table width='100%'>
                    <tr>
                        <td colspan='5' style="vertical-align:bottom;position:relative"><div style='font-weight:bold;position: absolute;bottom:10px'>Additional/conditional paragraphs</div>
                            <div id='paperMenu' style='float:right;margin:10px 0 10px;font-size:20px;border-radius:0' class='btn btn-default btn-primary'><span class='fa fa-bars'></span></div>
        ...
        <tr>
            <td><textarea name="body" class="form-control" placeholder="Regards, [staff name]"></textarea></td>
        </tr>
    </table>
    </div>
</form>
...
<script type="text/javascript">
    ...
    $('.addAdditional').on('click', function(){
        var newParagraph = "<tr><th colspan='5' style='padding:10px;background:#0886AF'>Additional paragraph (for <span class='totalStudents'>" + totalStudents + "</span> students) <span style='cursor:pointer;float:right' class='fa fa-times'></span></th></tr><tr><td colspan='5' style='background:#0886AF;padding:0 10px 10px'><textarea placeholder='Add some text to include in the email for all students' class='form-control'></textarea></td></tr>";
